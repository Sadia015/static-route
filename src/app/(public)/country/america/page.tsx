...
export default function America() {
    return (
        ...
        <div className="text-2xl py-2 "><span className="text-3xl">Name:</span>America</div>
       <div className="text-2xl py-2"><span className="text-3xl">Capital:</span>Washington, D.C</div>
       <div className="text-2xl py-2"><span className="text-3xl">Population:</span>124494116876</div>
